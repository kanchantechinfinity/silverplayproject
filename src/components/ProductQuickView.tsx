...
// Re-exported for existing imports — the implementation now lives in
// @/lib/rating (a plain, non-"use client" module) so server components like
// ProductReviews can call it directly without crossing the client boundary.
export { placeholderRating };
